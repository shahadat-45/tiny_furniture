 ...
 <div class="row">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateHeadding">Update Headding</button>
                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#create_Modal">Create Material</button>
            </div>
        </div>
    ...
    <div class="modal fade" id="updateHeadding" tabindex="-1" style="display: none;" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel3">Update Headding</h5>
            ...
            <div class="modal-body">
                <form id="headdingForm" enctype="multipart/form-data">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" id="title" name="title" class="form-control" placeholder="Title....." value="{{ $headding->title }}">
                    </div>
                    <div class="col mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea id="description" name="description" class="form-control" placeholder="Description....." cols="20" rows="5">{{ $headding->description }}</textarea>
                    </div>
     ...
     $(document).ready(function(){
        ...
        $("#headdingForm").submit(function (e) {
            ...
            $.ajax({
                ...
                url: "{{ url('admin/material/headding') }}/" + id,
                data: formData,
                processData: false,  // Prevent jQuery from processing the data
                contentType: false,  // Prevent jQuery from setting contentType
                success: function (res) {
